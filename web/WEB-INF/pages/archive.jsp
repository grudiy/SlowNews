            ...
            <div class="news-item">
                <div class="news-item-image-container">
                    ...
                    <div class="news-item-image">
                        <a href="<%=archiveItem.getLink()%>"><img src="<%=archiveItem.getImageURL()%>"
                                                                  title="<%=archiveItem.getTitle()%>"></a>
                    </div>
                </div>
                <div class="news-item-text">
                    <div class="news-item-title">
                        <h2><a href="<%=archiveItem.getLink()%>"><%=archiveItem.getTitle()%>
                        </a></h2>
                    </div>
                    <div class="news-item-date"><%=archiveItem.getDate()%>
                    </div>
